    ...
    <div className="bg-[#d9d9d9] relative w-[360px] h-[500px]">
      ...
      <div className="absolute contents left-[30px] top-[175px]">
        <button
          ...
          className="absolute bg-[#ca3333] h-[25px] left-[30px] rounded-[18px] top-[203px] w-[245px] cursor-pointer hover:bg-[#b02a2a] disabled:bg-gray-400 disabled:cursor-not-allowed"
        >
      ...
      <div className="absolute contents left-[30px] top-[250px]">
        ...
        <div className="absolute bg-white h-[130px] left-[30px] top-[285px] w-[293px] border border-gray-300 rounded overflow-auto p-2">
          {fetchError && (
